...
class Wukong(unittest.TestCase):
    ...
    def test_specialSale_new(self):
        ...
        # driver.find_element_by_xpath("//div[a/big[text()='马上加入']]").click()   #点击马上加入
        elements = driver.find_element_by_xpath("//div[a/big[text()='马上加入']]")
        print count(elements)
        # print (driver.find_element_by_xpath("//div[a/big[text()='马上加入']]/a/big").text)
        # driver.find_element_by_xpath("//*[@id='productInfo']/li[8]/div/div[2]/div[2]").click()

        # //*[@id="productInfo"]/li[9]/div/div[2]/div[2]
